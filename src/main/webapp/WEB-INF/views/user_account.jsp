...
<body id="mainBody">
	...
	<div id="contentContainer">
		<div class="contentTitleContainer">
			<h2 class="contentTitle">Update User Account</h2>
		</div>
		<div id="formDiv">
			...
			<form:form modelAttribute="account" method="POST"
				...
				<div style="margin: 20px 0px;" class="form-group row">
					...
					<input class="formInput" type="text" name="firstName" 
						   value="${account.userProfile.firstName}" placeholder="First Name" />
				</div>

				<div style="margin: 20px 0px;" class="form-group row">
					<label class="formLabel" for="lastName">Last Name:</label> 
					<input class="formInput" type="text" name="lastName" 
					       value="${account.userProfile.lastName}" placeholder="Last Name" />
				</div>

				<div style="margin: 20px 0px;" class="form-group row">
					<label class="formLabel" for="file">Signature:</label> 
					<input class="formFileInput" type="file" name="file" />
				</div>
