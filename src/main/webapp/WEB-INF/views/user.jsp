...
<body>
	<div class="container">
		...
		<ul class="nav nav-pills nav-justified">
			...
			<li class="nav-item">
				<a class="nav-link btn btn-outline-primary" href="${pageContect.request.contextPath}/user/${user.userId}">Update Profile</a>
			</li>
		...
		<h3 style="margin: 30px" align="center">AWARD LIST</h3>
